...
class FreeTypeFont(object):
    ...
    def getsize(self, text, direction=None, features=None, kerning=0):
        size, offset = self.font.getsize(text)
        size, offset = self.font.getsize(text, direction, features, kerning)
    ...
    def getmask2(self, text, mode="", fill=Image.core.fill, direction=None, features=None, kerning=0, *args, **kwargs):
        size, offset = self.font.getsize(text, direction, features, kerning)
        im = fill("L", size, 0)
        self.font.render(text, im.id, mode == "1", direction, features, kerning)
        return im, offset
...
class TransposedFont(object):
    ...
    def getsize(self, text, kerning=0, *args, **kwargs):
